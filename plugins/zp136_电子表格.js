...
function onInit({ exc, id, container, props, ctx }) {
    exc('load(["https://jsuites.net/v4/jsuites.css", "https://bossanova.uk/jspreadsheet/v4/jexcel.css", "https://bossanova.uk/jspreadsheet/v4/jexcel.js", "https://jsuites.net/v4/jsuites.js"])', null, () => {
        let model, present
        let past = []
        let future = []
        let fields = []
